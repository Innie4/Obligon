  ...
  return (
    <main className="min-h-screen bg-obligon-mist text-obligon-navy">
      <header className="flex h-16 items-center justify-between border-b border-obligon-border bg-white px-5 sm:px-8 lg:px-16">
        <Link href={routes.home} className="relative block h-16 w-[150px]" aria-label="Obligon LTD home">
          <Image src={assets.obligonLogo} fill sizes="150px" alt="Obligon LTD" className="scale-[1.4] object-contain" priority />
        </Link>
